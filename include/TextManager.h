...
private:
    ...
    static constexpr float GAME_OVER_X = Constants::windowWidth / 2.f;
    static constexpr float GAME_OVER_Y = Constants::windowHeight / 2.f;
    static constexpr float SCORE_X = 60.f;
    static constexpr float SCORE_Y = 10.f;
    static constexpr float LIVES_X = Constants::windowWidth - 60.f;
    static constexpr float LIVES_Y = 10.f;
    static constexpr float WIN_X = Constants::windowWidth / 2.f;
    static constexpr float WIN_Y = Constants::windowHeight / 2.f;
    static constexpr float PAUSE_X = Constants::windowWidth / 2.f;
    static constexpr float PAUSE_Y = Constants::windowHeight / 2.f;
